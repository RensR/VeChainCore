...
namespace VeChainCoreTest
{
    public class CryptoTest
    {
        ...
        public void TestBlake2B()
        {
            ...
            string hexString = blake2b.ByteArrayToString(StringType.Hex, Prefix.ZeroLowerX);
        ...
        public void TestKeccak()
        {
            ...
            string hexString = Keccac256.ByteArrayToString(StringType.Hex, Prefix.ZeroLowerX);
